...
// Forked from Apache Commons Lang 3.5.
...
public final class Range<T> implements Serializable {
	 ...
	 * @return the range object, not null
	 * @throws IllegalArgumentException if the element is null
	 * @throws ClassCastException if using natural ordering and the elements are
	 *           not {@code Comparable}
	 */
	public static <T> Range<T> is(final T element,
	...
	public boolean contains(final T element) {
		...
		return comparator.compare(element, minimum) > -1 && comparator.compare(
			element, maximum) < 1;
	}
	 ...
	 * the element is before the range, {@code 0} if contained within the range
	 * and {@code 1} if the element is after the range.
	 * </p>
	 *
	...
	public boolean isOverlappedBy(final Range<T> otherRange) {
		...
		return otherRange.contains(minimum) || otherRange.contains(maximum) ||
	...
	public Range<T> intersectionWith(final Range<T> other) {
		...
		final T max = getComparator().compare(maximum, other.maximum) < 0 ? maximum
			: other.maximum;
